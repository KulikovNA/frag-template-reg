"""One-scene overfit diagnostic config.

This config is for debugging / overfitting only. It uses the same train split
scene for train and val. Do not report it as generalization performance.
"""
